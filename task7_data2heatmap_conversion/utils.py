...
def create_idx_fixed_minmax(df, grid):
    '''
    ...
    # One degree of latitude =  110.57 km // height
    # One degree of longitude = 111.32 km // width

    pixw = round(110.57*(max_lon - min_lon)/map_width,2)
    pixh = round(111.32*(max_lat - min_lat)/map_height,2)
    print("At this configuration a pixel is about {} km by {} km".format(pixw,pixh))
